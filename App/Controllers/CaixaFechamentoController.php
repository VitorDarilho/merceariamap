...
class CaixaFechamentoController extends Controller
{
    ...
    {   
        ...
        #dd($dados);
        try {
            $caixafechamento = new CaixaFechamento();  
            $caixafechamento->save($dados);
            return $this->get->redirectTo("caixafechamento");
    ...
    public function index()
    {
       ...
       $this->view('caixafechamento/index', $this->layout);
    }
    
    public function modalFormulario($idCaixaFechamento)
    {
        $caixafechamento = false;
       ...
       # }
        ...
        $this->view('caixafechamento/formulario', null, compact('caixafechamento'));
    }
}