...
<nav class="navbar navbar-light" style="background:#2dd1ac;">
		<span class="navbar-toggler btn-sm btn" style="padding:0;border:0;outline:none">
            ...
            <span style="text-align:center!important;font-size:16px">Map Fest</span>
        </span>
</nav>
...
<div class="col-lg-12" id="menu">
    <ul class="list-group">
        ...
        <li class="list-group-item" disabled style="opacity:0.40">Estoque <small class="brand">Em breve</small></li>
